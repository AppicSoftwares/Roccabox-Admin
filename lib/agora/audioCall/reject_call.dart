...
class RejectCall extends StatefulWidget {
  CallModel? model;
  RejectCall({Key? key, this.model}):super(key:key);
  @override
  State<RejectCall> createState() => _RejectCallState();
}

class _RejectCallState extends State<RejectCall> {

  @override
  void initState() {
    super.initState();
    if(widget.model!=null){
      updateChatHead(widget.model, "end");
    }
  }
    ...
    return  Scaffold(
      ...
      body: isLoading==true?Center(child: CircularProgressIndicator(),):id!=null? StreamBuilder<DocumentSnapshot>(
          ...
          builder: (BuildContext context,
            ...
            children: [
              // Image
             args.sender_image.toString()=="null"? Image.asset(
